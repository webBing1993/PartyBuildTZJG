...
class Organization extends Admin {
    ...
    public function index() {
        ...
        $list = $this->lists('Organization',$where);
    ...
    public function push()
    {
        ...
        if ($arr1 == -1) {
            ...
            if($focus1['templet'] == 1) {
                $url1 = "http://www.0576ztnet.com/home/organization/detail/id/" . $focus1['id'] . ".html";
            }else {
                $url1 = "http://www.0576ztnet.com/home/organization/detail2/id/" . $focus1['id'] . ".html";
            }
        ...
        if (!empty($arr2)) {
            ...
            foreach ($arr2 as $key => $value) {
                ...
                if($focus['templet'] == 1) {
                    $url = "http://www.0576ztnet.com/home/organization/detail/id/" . $focus['id'] . ".html";
                }else {
                    $url = "http://www.0576ztnet.com/home/organization/detail2/id/" . $focus['id'] . ".html";
                }
