...
class Incorrupt extends Admin {
    ...
    public function index() {
        ...
        $list = $this->lists('Incorrupt',$where);
    ...
    public function del(){
        ...
        if($sta){
            if (Db::name('score')->where(['class' => 7,'aid' => $id])->find()){
                Db::name('score')->where(['class' => 7,'aid' => $id])->delete(); // 党风廉政
            }
    ...
    public function pushlist() {
        ...
        if(IS_POST){
            ...
            foreach ($infoes as $value) {
                switch ($value['type']) {
                    case 1:
                        $value['type_text'] = "【廉政责任】";
                        break;
                    case 2:
                        $value['type_text'] = "【廉政教育】";
                        break;
                    case 3:
                        $value['type_text'] = "【纪检报告】";
                        break;
                    default:
                        $value['type_text'] = "【无】";
                        break;
    ...
    public function push()
    {
        ...
        if ($arr1 == -1) {
            ...
            if($focus1['templet'] == 1) {
                $url1 = "http://www.0576ztnet.com/home/incorrupt/detail/id/" . $focus1['id'] . ".html";
            }else {
                $url1 = "http://www.0576ztnet.com/home/incorrupt/detail2/id/" . $focus1['id'] . ".html";
            }
        ...
        if (!empty($arr2)) {
            ...
            foreach ($arr2 as $key => $value) {
                ...
                if($focus['templet'] == 1) {
                    $url = "http://www.0576ztnet.com/home/incorrupt/detail/id/" . $focus['id'] . ".html";
                }else {
                    $url = "http://www.0576ztnet.com/home/incorrupt/detail2/id/" . $focus['id'] . ".html";
                }
