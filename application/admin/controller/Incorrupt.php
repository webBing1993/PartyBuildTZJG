...
class Incorrupt extends Admin {
    ...
    public function push()
    {
        ...
        if ($arr1 == -1) {
            ...
            if($focus1['templet'] == 1) {
                $url1 = "http://tzjg.0571ztnet.com/home/incorrupt/detail/id/" . $focus1['id'] . ".html";
            }else {
                $url1 = "http://tzjg.0571ztnet.com/home/incorrupt/detail2/id/" . $focus1['id'] . ".html";
            }
        ...
        if (!empty($arr2)) {
            ...
            foreach ($arr2 as $key => $value) {
                ...
                if($focus['templet'] == 1) {
                    $url = "http://tzjg.0571ztnet.com/home/incorrupt/detail/id/" . $focus['id'] . ".html";
                }else {
                    $url = "http://tzjg.0571ztnet.com/home/incorrupt/detail2/id/" . $focus['id'] . ".html";
                }
